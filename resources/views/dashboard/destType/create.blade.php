    ...
    <div class="flex flex-wrap -mx-3 gap-y-4">
        <div class="flex-none max-w-full px-3 w-fit">
            <a href="{{ route('admin.destination_type.index') }}"
                class="inline-block px-3 py-3 mx-3 mb-4 text-xs font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer w-fit bg-gradient-to-br from-slate-600 from-20% !to-gray-400 leading-pro ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs">
            ...
            <div
                ...
                <div
                    ...
                    <h6 class="mb-0">Tambah Tipe Destinasi</h6>
                </div>
                <div class="px-6 py-4 sm:px-8">
                    <form action="{{ route('admin.destination_type.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
